	...
	<%@ include file="/jsp/head.jsp" %>
		...
		<div style="width:380px;margin:0 auto;margin-top:50px;">
			<ul class="pagination" style="text-align:center; margin-top:10px;">
				...
				<c:if test="${pageBean.pageNumber != 1 }">
					<li >
						<a href="${pageContext.request.contextPath }/order?method=findMyOrdersByPage&pageNumber=${pageBean.pageNumber-1}&cid=${param.cid}" aria-label="Previous">
							<span aria-hidden="true">&laquo;</span>
						</a>
					</li>
				</c:if>
				...
				<c:forEach begin = "1" end = "${pageBean.totalPage }" var = "i">
					...
					<c:if test="${pageBean.pageNumber != i }">
						<li><a href="${pageContext.request.contextPath }/order?method=findMyOrdersByPage&pageNumber=${i}&cid=${param.cid}">${i }</a></li>
					</c:if>
				</c:forEach>
				...
				<c:if test="${pageBean.pageNumber != pageBean.totalPage }">
					<li >
						<a href="${pageContext.request.contextPath }/order?method=findMyOrdersByPage&pageNumber=${pageBean.pageNumber+1}&cid=${param.cid}" aria-label="Next">
							<span aria-hidden="true">&raquo;</span>
						</a>
					</li>
				</c:if>
