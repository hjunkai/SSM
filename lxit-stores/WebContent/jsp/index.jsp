			...
			<div class="container-fluid">
				...
				<c:forEach items = "${hotList }" var = "list">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath }/product?method=getById&pid=${list.pid}">
							<img src="${pageContext.request.contextPath}/${list.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath }/product?method=getById&pid=${list.pid}" style='color:#666'>${fn:substring(list.pname,0,10)}...</a></p>
				...
				<div class="col-md-10">
					...
					<c:forEach items = "${newList }" var = "list">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							...
							<p><a href="product_info.html" style='color:#666'>${fn:substring(list.pname,0,9)}...</a></p>
							<p><font color="#E4393C" style="font-size:16px">&yen;${list.shop_price }</font></p>
						</div>
					</c:forEach>
				</div>
